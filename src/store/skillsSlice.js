...
import deviceImg from '../assets/images/sass.png';
...
techSkills=[
    ...
    {icon:testImg,title:'Testing Applications',desp:'Built test cases with the help of Jest and Enzyme for React Application and added testing step in Gitlab CI-CD before deploying to production'},
    {icon:gitImg,title:'Source Code Management',desp:'Experience in managing Git Repositories with commnad line and deploying code with CI/CD pipelines to servers.'},
